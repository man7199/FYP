...
public class GameLauncher : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    public void SetSingle() => _gameMode = GameMode.Single;
    ...
    public void JoinOrCreateLobby()
    {
        ...
        _runner.StartGame(new StartGameArgs
        {
            ...
            PlayerCount = ServerInfo.UserCapacity,
            DisableClientSessionCreation = true
        });
        Debug.Log(_gameMode);
        Debug.Log(_gameMode == GameMode.Host ? ServerInfo.LobbyName : ClientInfo.LobbyName);
    }
